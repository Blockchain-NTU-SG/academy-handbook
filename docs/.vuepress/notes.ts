...
const academyNote = defineNoteConfig({
  ...
  sidebar: [
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Part 6 · Track selection card', link: '/foundation/week-4/part-6-direction-card.html' },
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        { text: 'Week 7 · Scope + MVP / V1', link: '/proof-of-work/week-7-mvp.html' },
        { text: 'Week 8 · Refine + Final PoW', link: '/proof-of-work/week-8-final.html' },
      ],
    },
