...
flowchart LR
  ...
  O["<b>Optimise for openness</b>"] --> O1["more independent<br/>validators"] --> O2["more coordination"] --> O3["<b>slower and dearer</b>"]
```
...
::: tabs
@tab <Icon name="simple-icons:bitcoin" /> Bitcoin
...
@tab <Icon name="simple-icons:ethereum" /> Ethereum
...
@tab <Icon name="simple-icons:solana" /> Solana
...
| | Bitcoin | Ethereum | Solana | Cosmos | Avalanche |
|---|---|---|---|---|---|
